  	 ...
  	 <table bordercolor='#898E90' align='center' border='3px' cellpadding='10px' cellspacing="0px">
          ...
          <c:forEach items="${list }" var="order">
	          <tr align='center'> 
				  ...
				  <td>${order.adress.local}</td>
				  <td><fmt:formatDate value="${order.create_Date }" pattern="yyyy-MM-dd" /></td>
	              <td> 
				  	<input class="button btn-order" onclick="location.href='${pageContext.request.contextPath}/order/showItem?id=${order.id}'" value="订单详细信息 &raquo;" />
				  </td>
	          </tr>
          </c:forEach>
     </table> 
