...
<script type="text/javascript">
	function changeImage(){
		$("#imgVcode").attr({"src":"${pageContext.request.contextPath}/a/capcherAction?t="+Math.random()});
	}
</script>
	...
	<div class="login_bg" style="width:960px; margin:0 auto;">
		...
		<div class="set_area clearfix">
			<div class="wrap clearfix">
				<div id="J_loginDiv">	
					<form action="/maven_test2 Maven Webapp/src/main/webapp/index.jsp" method="post">
						<!-- 得到message错误信息，在jsp页面打印出来 -->
						...
						<div id="J_loginCoreWrap" class="infro">
							...
							<div id="J_captchVcodeWrap" style="" class="Captcha">
								<div class="code" style="width:100px;">
									<input type="text" name="capther" />
								</div>
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="capther" href="javascript:void(0);">
									<%-- 		<img id="imgVcode" src="${pageContext.request.contextPath}/a/capcherAction" class="Ucc_captcha Captcha-image" onClick="changeImage()"> --%>
										</a>
										<a id="vcodeImgBtn" name="capther" class="code_picww" href="javascript:changeImage()">换张图</a> 
