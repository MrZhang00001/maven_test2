...
<body style="text-align:center;font-family:'KaiTi';">
	...
	<div style="padding-top: 8px;">
		...
		<div style="position:absolute;right:24px;">
			<div onclick="window.parent.location.href='${pageContext.request.contextPath}/a/loginOut'" class="btn-logout">安全退出</div>
		</div>
		<div style="font-size:24px;line-height:36px;position:absolute;right:162px;color:#d74b4b">当前管理员:${session.admin.username}</div>
